...
realName：<input type="text" name="realName" value="${student.realName}" /> <br />
dorm：<input type="text" name="dorm" value="${student.dorm}" /> <br />
duty：<input type="text" name="duty" value="${duty}" /> <br />
phoneNo：<input type="text" name="phoneNo" value="${student.phoneNo}" /> <br />
qq：<input type="text" name="qq" value="${student.qq}" /> <br />
mail：<input type="text" name="mail" value="${student.mail}" /> <br />
