		...
		<div id="content">
			<div id="sidebar">
				<ul>
					...
					<li><a href="<%=path %>/activity/list">活动加分</a> - <a href="<%=path %>/activity/addLink?sno=${sessionScope.student.sno}">申请</a></li>
					<li><a href="<%=path %>/classfee/queryAllclassFee">班费管理</a> - <a href="<%=path %>/classfee/addLink">添加</a> </li>
