				...
				<c:otherwise>
					...
					<s:iterator value="pageBean.list" var="activity">  
					 ...
					 <div id="pagecount">
						 ...
						 <s:else>  
						     <a href="<%=path %>/activity/listPage?page=1"><span>首页</span></a>
						     <a href="<%=path %>/activity/listPage?page=<s:property value="%{pageBean.currentPage-1}"/>"><span>上一页</span></a>
						 </s:else>  
						 <s:if test="%{pageBean.currentPage != pageBean.totalPage}">  
						     <a href="<%=path %>/activity/listPage?page=<s:property value="%{pageBean.currentPage+1}"/>"><span>下一页</span></a>
						     <a href="<%=path %>/activity/listPage?page=<s:property value="pageBean.totalPage"/>"><span>尾页</span></a>
						 </s:if>  
						 <s:else>
						 <a><span>下一页</span></a>
						 <a><span>尾页</span></a>
