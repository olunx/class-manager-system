...
<div id="header">
  ...
  <div id="header_tool"><a id="btn_main" href="jump?url=first.jsp">首页</a> <a id="btn_back" href="javascript:history.back();">后退</a> <a id="btn_forward" href="javascript:history.forward();">前进</a></div>
  <div id="header_right">
